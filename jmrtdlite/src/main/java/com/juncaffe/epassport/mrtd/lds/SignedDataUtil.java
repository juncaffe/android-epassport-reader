...
public final class SignedDataUtil {
  ...
  public static ASN1Primitive getContent(SignedData signedData) {
    ASN1Sequence signedDataSeq = (ASN1Sequence) signedData.toASN1Primitive();
    ASN1Encodable encapContentInfoObj = signedDataSeq.getObjectAt(2);
    ContentInfo encapContentInfo = ContentInfo.getInstance(encapContentInfoObj);
  ...
  public static byte[] getEContent(SignedData signedData) throws SignatureException {
    ...
    ASN1Sequence signedDataSeq = (ASN1Sequence) signedData.toASN1Primitive();
    ASN1Encodable encapContentInfoObj = signedDataSeq.getObjectAt(2);
    ContentInfo contentInfo = ContentInfo.getInstance(encapContentInfoObj);
  ...
  public static IssuerAndSerialNumber getIssuerAndSerialNumber(SignedData signedData) {
    ...
    BigInteger serialNumber = issuerAndSerialNumber.getCertificateSerialNumber().getValue();
   ...
   * @throws GeneralSecurityException on error
   */
  public static SignedData createSignedData(String digestAlgorithm, String digestEncryptionAlgorithm, AlgorithmParameterSpec digestEncryptionParameters, String contentTypeOID, ContentInfo contentInfo, byte[] encryptedDigest, X509Certificate docSigningCertificate) throws GeneralSecurityException {
    ...
    return new SignedData(version, digestAlgorithmsSet, contentInfo, certificates, null, signerInfos);
  }
  ...
  public static SignerInfo createSignerInfo(String digestAlgorithm,
    ...
    IssuerAndSerialNumber issuerAndSerialNumber = new IssuerAndSerialNumber(docSignerName, serial);
    ASN1Integer version = new ASN1Integer(1);
    ...
    return new SignerInfo(version, issuerAndSerialNumber, digestAlgorithmObject, authenticatedAttributes, digestEncryptionAlgorithmObject, encryptedDigestObject, unAuthenticatedAttributes);
  }
