...
abstract class DataGroup : AbstractTaggedLDSFile {
     ...
     */
    protected constructor(dataGroupTag: Int, inputStream: InputStream, onProgress: PassportService.ProgressListener?) : super(dataGroupTag, inputStream, onProgress)

    protected constructor(dataGroupTag: Int, inputStream: InputStream) : super(dataGroupTag, inputStream, null)
